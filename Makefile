...
dist:
	fpm -s dir \
		...
		-f -p galeb-webui-${VERSION}.el7.noarch.rpm css=/opt/galeb/htdocs/ img=/opt/galeb/htdocs/ index.html=/opt/galeb/htdocs/ scripts=/opt/galeb/htdocs/ views=/opt/galeb/htdocs/
